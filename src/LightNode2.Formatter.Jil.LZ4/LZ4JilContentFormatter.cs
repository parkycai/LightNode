...
namespace LightNode2.Formatter
{
    public class LZ4JilContentFormatter : ContentFormatterBase
    {
        ...
        public override void Serialize(System.IO.Stream stream, object obj)
        {
            ...
            using (var lz4 = new LZ4Stream(stream, LZ4StreamMode.Compress, blockSize: 1024 * 64))
        ...
        {
            using (var gzip = new LZ4Stream(stream, LZ4StreamMode.Decompress, blockSize: 1024 * 64))
